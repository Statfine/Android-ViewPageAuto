...
public class ListAdapterOne extends BaseAdapter {
	...
	public ListAdapterOne(Context context){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.adapter_iv.setImageDrawable(mContext.getResources().getDrawable(R.drawable.s_weibo2x));
        holder.adapter_tv.setText("Adapter One");
